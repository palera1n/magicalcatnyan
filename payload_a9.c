...
char* rootdev = (char*)(PAYLOAD_BASE_ADDRESS_A9 + 0x60);
uint8_t* invert_fb = (uint8_t*)(PAYLOAD_BASE_ADDRESS_A9 + 0x70);
uint8_t* xargs_set = (uint8_t*)(PAYLOAD_BASE_ADDRESS_A9 + 0x71);
char* CommandLine = (char*)(PAYLOAD_BASE_ADDRESS_A9 + 0x72);
...
{
    if(*(uint32_t*)PAYLOAD_BASE_ADDRESS_A9 == 0)
    {
...
int iboot_func_init(void)
{
    ...
    if(*(uint32_t*)PAYLOAD_BASE_ADDRESS_A9 == 0)
    {
        ...
        memcpy((void*)PAYLOAD_BASE_ADDRESS_A9, (void*)0x800000000, 0x80000);
        ...
        uint64_t* offsetBase = (uint64_t*)(PAYLOAD_BASE_ADDRESS_A9 + 0x40);
